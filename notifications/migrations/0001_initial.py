...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"ordering": ["-created_at"], "verbose_name": "Systemnachricht", "verbose_name_plural": "Systemnachrichten", "indexes": [models.Index(fields=["organization", "recipient", "read_at"], name="notificatio_organiz_a630a1_idx"), models.Index(fields=["recipient", "delivery_status", "created_at"], name="notificatio_recipie_0d6a5d_idx")]},
        ),
        migrations.CreateModel(
            ...
            options={"ordering": ["-assigned_at"], "verbose_name": "Mangel-Zuweisung", "verbose_name_plural": "Mangel-Zuweisungen", "indexes": [models.Index(fields=["organization", "assigned_to", "assigned_at"], name="notificatio_organiz_8d0483_idx")]},
        ),
        migrations.CreateModel(
            ...
            options={"ordering": ["user__username", "-last_seen_at"], "verbose_name": "Push-Gerät", "verbose_name_plural": "Push-Geräte", "indexes": [models.Index(fields=["user", "organization", "is_active"], name="notificatio_user_id_1754cd_idx")]},
        ),
    ]
